...
| **path-of-angels-excellence** | `GOAL-PATH-OF-ANGELS-EXCELLENCE.md` | make the PoA game genuinely excellent and use each game demand as a forcing function on dregg: committed seeds (the 3 shipped games publish their answers), a judged-transition effect the AIR can see (EmitEvent projects to 2 hashes), the 8-field state ceiling, a design gate that can say "not fun", curator authority as a dregg capability |
