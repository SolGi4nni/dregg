...
//! EffectVM as a REAL foreign-consensus leaf (the VK-epoch). ⚑ This line used to name
//! `dregg_circuit::bridge_action_witness`; that AIR is DELETED (2026-08-07). That weld is owned
