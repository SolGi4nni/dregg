...
/// The wire string Lean's `emitVmJson2 compoundPredicateDesc` emits, read from the emitted
/// artifact (routed 2026-08-06; was a hand-copied literal).
const COMPOUND_GOLDEN: &str =
    include_str!("../../circuit/descriptors/by-name/compound-predicate.json");

/// The wire string Lean's `emitVmJson2 relationalPredicateDesc` emits, read from the emitted
/// artifact (routed 2026-08-06; was a hand-copied literal).
