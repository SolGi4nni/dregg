...
| `Compress8CR` | `metatheory/Dregg2/Circuit/DeployedCapTree.lean:630` | node8 arity-16 compression injective | terminal-by-design | The shared 8-felt Merkle node CR. |
...
| `GnarkRefines` / `TranscriptRefines` | `metatheory/Dregg2/Circuit/FriVerifier.lean:849,861` | gnark circuit computes the SAME Bool / challenger as Lean `verifyAlgo` | terminal **code-trust** (not crypto) | A Rust/Go↔Lean *code refinement*, honestly labeled, fixture-anchored. |
...
**`lightclient_unfoolable`** (`metatheory/Dregg2/Circuit/CircuitSoundness.lean:453`, `#assert_axioms`
