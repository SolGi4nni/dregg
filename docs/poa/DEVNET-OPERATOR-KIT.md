...
"$POA_BIN" init-poa-signal \
  ...
  --expected-activation-counter 12
```
...
this line said `2` until 2026-08-09 and `10` until 2026-08-12, so an operator
running it verbatim got a counter refusal and no hint that the doc, rather than their kit, was wrong. Read
