...
async fn get_offering_session(
    ...
    match opened {
        ...
        Err(CatalogGameError::Host(HostError::UnknownOffering(_))) => {
            ...
            // page — the machine-readable answer contradicting the human-readable one. The sibling
            // arms below already carry honest codes (429/409); this one was the outlier.
