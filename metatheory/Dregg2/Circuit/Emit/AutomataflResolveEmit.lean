...
/-- End of the CHUNK-5 tail — the new total width. -/
...
rewrite (`CV2_0 … MV2_END`), and the CHUNK-5 corrected FLOW-THROUGH surface (`V3_0 … MV3_END`). -/
def R_WIDTH : Nat := MV3_END
...
def R_WIDTH (n : Nat) : Nat := MV3_END n
...
#guard automataflResolveDesc.traceWidth == 443
...
-- nonLeaveV2 18 + carryV3 2 + resolvableV2 29 + midV3 8 = 83) = 534.
#guard automataflResolveDesc.constraints.length == 534
...
#guard cMidV3 0 == 439
#guard cMidV3 (KK - 1) + 1 == R_WIDTH     -- the corrected FLOW-THROUGH board is the trace tail
#guard MV3_END == R_WIDTH
...
#guard (NGen.resolveConstraints 2).length == 534
...
#guard NGen.cMidV3 11 (NGen.KK 11 - 1) + 1 == NGen.R_WIDTH 11   -- the corrected board is the trace tail
#guard NGen.MV3_END 11 == NGen.R_WIDTH 11
