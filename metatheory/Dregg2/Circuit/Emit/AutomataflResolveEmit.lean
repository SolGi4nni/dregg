...
-- (twoCyc 4 + carryV4 2 + midV4 8 = 14; occupancy-blind detector, seventh-wound repair) = 548.
#guard automataflResolveDesc.constraints.length == 548
...
#guard (NGen.resolveConstraints 2).length == 548
