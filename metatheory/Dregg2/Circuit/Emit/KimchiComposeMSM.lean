...
def composeMsmJson : String := renderCircuit "composeMsm_vbm_then_add" 0 4 composePlaced composeWitness
/-- The rendered UNWIRED control circuit (row 3 not shared). -/
def composeMsmUnwiredJson : String :=
  renderCircuit "composeMsm_vbm_then_add_UNWIRED" 0 4 composePlacedUnwired composeWitness
