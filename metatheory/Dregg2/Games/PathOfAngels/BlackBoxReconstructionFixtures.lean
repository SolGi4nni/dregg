...
theorem five_positions_cost_exactly_fifteen_probes :
    check_five_positions_cost_exactly_fifteen_probes = true := by native_decide

theorem scan_worst_case_is_the_budget :
    check_scan_worst_case_is_the_budget = true := by native_decide
