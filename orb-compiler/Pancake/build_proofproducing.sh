...
for f in Dsl/EmitPancake Pancake/Sem Pancake/Lower Pancake/EmitCorrectRegion Pancake/EmitCorrectCompose Pancake/EmitCorrectLoop Pancake/EmitCorrectClock Pancake/ProofProducing; do
  echo "building $f ..."
...
#print axioms refinesClkOf               -- the LOOP-BEARING translator (proof-producing)
#print axioms scanPublish_auto           -- a LOOP stage auto-compiled (no hand induction)
EOF
