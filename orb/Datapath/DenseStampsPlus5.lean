...
#guard (serveMeteredPlus5HeadIdx cleanPeer 512 bulkDemoReq).data.toList
        == (drorbServeMeteredPlus5 cleanPeer 512 bulkDemoReq).data.toList
...
#guard (serveMeteredPlus5HeadIdx cleanPeer 512 bulkDemoReq).size < 1024
...
/-! ## 9. Axiom audit — expect ⊆ {propext, Quot.sound, Classical.choice}. -/
