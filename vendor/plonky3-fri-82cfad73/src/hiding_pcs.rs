...
use crate::{CpuTwoAdicFriFold, FriParameters, FriProof, TwoAdicFriFoldBackend, TwoAdicFriPcs};
...
impl<Val, Dft, InputMmcs, FriMmcs, R, Fold> HidingFriPcs<Val, Dft, InputMmcs, FriMmcs, R, Fold> {
